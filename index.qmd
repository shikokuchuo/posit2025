...
-   NNG - IPC / TCP / secure TLS - x-language data format support
...
-   Modular compute profiles \| local, remote (SSH), cluster (Slurm,
    SGE, LSF, PBC)
...
![](images/forcats.png){width="180"} ![](images/mirai.png){width="180"}
